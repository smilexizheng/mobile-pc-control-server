  ...
  switch (platform) {
    ...
    case 'darwin': {
      ...
      try {
        ...
        osString =
          arch === 'arm64' ? `Mac OS X ${versionString}` : `Intel Mac OS X ${versionString}` // Mac OS X 15_0_0
      } catch (error) {
...
export function generateUserAgent(): string {
  ...
  return `Mozilla/5.0 (${systemInfo.osString}; ${systemInfo.archString}) AppleWebKit/537.36 (KHTML, like Gecko) ControlServe/${systemInfo.appVersion} Chrome/124.0.0.0 Safari/537.36`
}
